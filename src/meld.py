#
# meld.py
# created by DanchengZ, edited by Intel0tw5727
#
    ...
    def __init__(self, meld):
        ...
        if (meld >> 2) & 1:
            ...
            # TODO
                ...
                # self._meldtype = '杠'
                self._meldtype = '明カン' if (meld & 3) else '暗カン'
                furu = (meld >> 8) & 255
                q = furu >> 2
                self._handTile = [q, q]
                self._nakiTile = q
        ...
        self._printIndex = [self._meldtype, self._seatFrom, self._handTile[0], self._handTile[1], self._nakiTile]

    def getInfo(self):
        return self._printInfo

    def getIndex(self):
        return self._printIndex
